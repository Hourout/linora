...
class RandomWalker:
    ...
    def deepwalk_walks(self, walk_num, walk_length, filter_lenth=0, workers=1, verbose=0):
        return self._parallel_walks(self._deepwalk_walks, walk_num, walk_length, filter_lenth, workers, verbose)
        
    def deepwalk_walk(self, walk_length, start_node, filter_lenth=0):
        walk = [start_node]
    ...
    def _parallel_walks(self, method, walk_num, walk_length, filter_lenth, workers, verbose):
